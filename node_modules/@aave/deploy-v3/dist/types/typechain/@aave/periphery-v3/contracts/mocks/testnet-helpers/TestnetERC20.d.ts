...
export interface TestnetERC20Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "EIP712_REVISION" | "PERMIT_TYPEHASH" | "allowance" | "approve" | "balanceOf" | "decimals" | "decreaseAllowance" | "increaseAllowance" | "isProtected" | "mint(address,uint256)" | "mint(uint256)" | "name" | "nonces" | "owner" | "permit" | "renounceOwnership" | "setProtected" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership"): FunctionFragment;
...
//# sourceMappingURL=TestnetERC20.d.ts.map