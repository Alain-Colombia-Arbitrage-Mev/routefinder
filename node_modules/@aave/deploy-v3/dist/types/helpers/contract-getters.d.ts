...
export declare const getFaucet: (address?: string) => Promise<Faucet>;
...
export declare const getOwnableContract: (address: string) => Promise<import("ethers").Contract>;
//# sourceMappingURL=contract-getters.d.ts.map